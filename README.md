...
## 📊 Principais Insights
- O sistema Android domina o mercado (~89% dos dispositivos).
- Marcas como Samsung e Realme apresentaram as maiores médias de avaliação.
- Abril foi o mês com maior faturamento e maior número de lançamentos.
- O suporte ao 5G não apresentou impacto significativo na avaliação média.
- Preço mais alto não implica necessariamente melhor avaliação.
